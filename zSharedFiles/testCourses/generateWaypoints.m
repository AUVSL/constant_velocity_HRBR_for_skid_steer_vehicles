...
%zero endpoints are repeated. This is delete the repeat 0 point
wptSize = size(waypoints);
a = waypoints(wptSize, 1) == 0 & waypoints(wptSize, 2) == 0;
if a(1)
    waypoints = [waypoints([1:wptSize-1], 1), waypoints([1:wptSize-1], 2)];
end
